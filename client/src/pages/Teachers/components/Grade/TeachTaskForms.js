            ...
            >
              ...
              {userData &&
                ...
                subjects
                  .filter((subj) => {
                    return (
                      subj.levelID === getStudentData.levelID &&
                      userData?.SubjectLoads?.some((e) => e === subj?.subjectID)
                    );
                  })
                  .map((val) => {
                    return (
